...
QDEF(MP_QSTR_bcc, (const byte*)"\x27\x47\x03" "bcc")
...
QDEF(MP_QSTR_certificate, (const byte*)"\xd0\xff\x0b" "certificate")
...
QDEF(MP_QSTR_distance, (const byte*)"\xe6\xde\x08" "distance")
...
QDEF(MP_QSTR_forceFactory, (const byte*)"\x2c\x9d\x0c" "forceFactory")
...
QDEF(MP_QSTR_fromfile, (const byte*)"\xf5\x42\x08" "fromfile")
...
QDEF(MP_QSTR_get_str, (const byte*)"\xb9\xb0\x07" "get_str")
QDEF(MP_QSTR_get_u16, (const byte*)"\x5e\x8f\x07" "get_u16")
QDEF(MP_QSTR_get_u32, (const byte*)"\x98\x8f\x07" "get_u32")
QDEF(MP_QSTR_get_u64, (const byte*)"\x7b\x90\x07" "get_u64")
QDEF(MP_QSTR_get_u8, (const byte*)"\x61\x42\x06" "get_u8")
...
QDEF(MP_QSTR_getmail, (const byte*)"\xfa\xd8\x07" "getmail")
...
QDEF(MP_QSTR_lwt_msg, (const byte*)"\x4c\xbe\x07" "lwt_msg")
QDEF(MP_QSTR_lwt_qos, (const byte*)"\xd8\x6b\x07" "lwt_qos")
QDEF(MP_QSTR_lwt_retain, (const byte*)"\x90\xe0\x0a" "lwt_retain")
QDEF(MP_QSTR_lwt_topic, (const byte*)"\xf4\x91\x09" "lwt_topic")
...
QDEF(MP_QSTR_multipart, (const byte*)"\x7b\xcf\x09" "multipart")
QDEF(MP_QSTR_name, (const byte*)"\xa2\x75\x04" "name")
QDEF(MP_QSTR_namedtuple, (const byte*)"\x1e\x16\x0a" "namedtuple")
QDEF(MP_QSTR_namespace, (const byte*)"\x26\xc0\x09" "namespace")
...
QDEF(MP_QSTR_nvs, (const byte*)"\x8e\x5a\x03" "nvs")
...
QDEF(MP_QSTR_opts, (const byte*)"\xfd\x38\x04" "opts")
...
QDEF(MP_QSTR_readScreen, (const byte*)"\xdb\x4d\x0a" "readScreen")
QDEF(MP_QSTR_read_parse, (const byte*)"\xfd\x9f\x0a" "read_parse")
...
QDEF(MP_QSTR_req, (const byte*)"\x63\x8b\x03" "req")
QDEF(MP_QSTR_requests, (const byte*)"\x87\xbe\x08" "requests")
...
QDEF(MP_QSTR_roaming, (const byte*)"\x94\x16\x07" "roaming")
...
QDEF(MP_QSTR_set_bootpart, (const byte*)"\xb9\x33\x0c" "set_bootpart")
...
QDEF(MP_QSTR_set_str, (const byte*)"\xad\x84\x07" "set_str")
QDEF(MP_QSTR_set_u16, (const byte*)"\x4a\x84\x07" "set_u16")
QDEF(MP_QSTR_set_u32, (const byte*)"\x8c\x84\x07" "set_u32")
QDEF(MP_QSTR_set_u64, (const byte*)"\x6f\x84\x07" "set_u64")
QDEF(MP_QSTR_set_u8, (const byte*)"\xf5\xe4\x06" "set_u8")
...
QDEF(MP_QSTR_startservice, (const byte*)"\x18\x80\x0c" "startservice")
...
QDEF(MP_QSTR_stopservice, (const byte*)"\x00\x84\x0b" "stopservice")
